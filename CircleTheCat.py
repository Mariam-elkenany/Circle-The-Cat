...
class GameWidget(QtWidgets.QWidget):
    _tile_brushes = {
            '.' : QtGui.QBrush(QtGui.QColor.fromRgb(162, 214, 249)),
            '~' : QtGui.QBrush(QtGui.QColor.fromRgb(240, 166, 202)),
    ...
    def __init__(self, mainWidget, dim, *args, **kws):
        ...
        self.cat_brush = QtGui.QBrush(QtGui.QColor.fromRgb(255, 166, 43))
        self.update_fov()
...
class MyWidget(QWidget):
    ...
    def layoutUI(self):
        ...
        self.dimLabel = QLabel("Circle the Cat Game\nis an NxN HexGrid\n\nEnter an odd number for N:")
...
def main():
    ...
    w = MyWidget()
    w.setWindowTitle("Circle the Cat")
